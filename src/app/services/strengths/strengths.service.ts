...
export class StrengthsService {
  ...
  strengthReasons = [
    ...
    { reason: "Your password contains a penis. No wonder it's so insecure: it's short as.", tag: "penis", hidden: true, answer:"Remove that dick/cock/willy/prick/knob/rod/phallus reference."},
    { reason: "Your password does not contain a vagina. Should put one in. They're bloody (sorry) strong.", tag: "vagina", hidden: false, answer:"Include a vagina/coochie/c***/pussy/snatch/beaver/flower/peach reference."},
    ...
    { reason: "Your password should also be mentally strong. Tell it you love it, no matter what.", tag: "love", hidden: false, answer:"Type: \"I love you, Password.\""},
    ...
    { reason: "Trivia time: How easy is it to keep a Prime Minister for a full term in office in Australia? a) Easy, b) Hard, c) Frigging impossible", tag: "pm", hidden: false, answer:"This will be news to the global audience, but it's B and C."},
    ...
    { reason: "C'mon, mate. You've put a weak base/acid in your password. Get rid of it.", tag: "acid", hidden: true, answer:"Had to Google this one too: formic/acetic/trichloroacetic/hydrofluoricammonia/pyridine/ammonium/hyroxide (among others)."},
